...
export const CardProject = ({ title, category, repo, link }: CardProjectProps) => {
  return (
    <AnimationContainer customClassName='w-72 h-52 flex flex-col justify-center items-center rounded border border-gray-200 dark:border-gray-800 hover:border-white dark:hover:border-gray-900 bg-gray-50 dark:bg-gray-900 shadow-sm hover:shadow-[0_8px_30px_rgb(0,0,0,0.12)] transition-all ease'>

      <div className='flex flex-col justify-center items-center rounded gap-5'>
        ...
        <div className='flex flex-wrap gap-1'>
          {
            category.map(tech => (
              <span
                key={tech}
                className='rounded bg-gray-200 px-2.5 py-0.5 text-xs text-black dark:bg-gray-800 dark:text-white'>
                {tech}
              </span>
            ))
          }
        ...
        <div className='flex justify-center items-center gap-3'>
          ...
          <ExternalLink href={repo} customClassName='text-black dark:text-white inline-flex items-center rounded-lg bg-white dark:bg-black p-2 dark:hover:bg-gray-800 hover:bg-gray-200 transition-all ease'>
            <svg xmlns='http://www.w3.org/2000/svg' fill='none' width='24px' height='24px' viewBox='-6 0 32 32' stroke='currentColor' version='1.1'>
              <title>github</title>
          ...
          <ExternalLink href={link} customClassName='text-black dark:text-white inline-flex items-center rounded-lg bg-white dark:bg-black p-2 dark:hover:bg-gray-800 hover:bg-gray-200 transition-all ease'>
            <svg xmlns='http://www.w3.org/2000/svg' fill='none' width='24px' height='24px' viewBox='0 0 512 512' id='Layer_1' stroke='currentColor'>
