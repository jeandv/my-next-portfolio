  ...
  return (
    <div>
      <SectionContainer>
        ...
        <div className='flex justify-center flex-col-reverse lg:flex-row items-center lg:items-start'>

          <AnimationContainer customClassName='flex flex-col items-center justify-center lg:items-start p-0 lg:pr-8'>
          ...
          <AnimationContainer customClassName='w-[80px] sm:w-[176px] relative mb-6 lg:mb-0 mx-auto'>
            <Image
              alt='Jean Rondón'
              height={176}
              width={176}
