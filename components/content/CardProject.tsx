...
const CardProject = ({ title, des, category, repo, link }: CardProjectProps) => {
  return (
    <AnimationContainer customClassName='w-full h-42 flex flex-col justify-center items-center rounded border border-gray-800 hover:border-gray-900 bg-gray-900 shadow-sm hover:shadow-[0_8px_30px_rgb(0,0,0,0.12)] p-4 transition-all ease'>
      ...
      <div className='w-full flex flex-col justify-center items-start rounded gap-5'>
        ...
        <div className='w-full flex justify-between items-start flex-wrap flex-col lg:flex-row gap-5'>
          ...
          <div className='flex justify-center items-end gap-3'>
            ...
            <ExternalLink href={repo} customClassName='text-white inline-flex items-center rounded-lg bg-black p-2 hover:bg-gray-800 transition-all ease'>
            ...
            <ExternalLink href={link} customClassName='text-white inline-flex items-center rounded-lg bg-black p-2 hover:bg-gray-800 transition-all ease'>
