  ...
  return (
    ...
    >
      ...
      <div className='flex items-center justify-end gap-3'>
        ...
        <ExternalLink href={repo} customClassName='text-black dark:text-white inline-flex items-center rounded-lg bg-white dark:bg-black p-2 dark:hover:bg-gray-800 hover:bg-gray-200 transition-all ease shadow-[0_8px_30px_rgb(0,0,0,0.12)]'>
        ...
        <ExternalLink href={link} customClassName='text-black dark:text-white inline-flex items-center rounded-lg bg-white dark:bg-black p-2 dark:hover:bg-gray-800 hover:bg-gray-200 transition-all ease shadow-[0_8px_30px_rgb(0,0,0,0.12)]'>
  ...
  return (
    <AnimationContainer customClassName='w-full flex flex-col justify-center text-center lg:items-start mb-16'>
      ...
      <p className='text-base text-gray-600 dark:text-gray-400 mb-10 text-start'>
        These are my favorite projects and also the ones I consider the most complete and complex I have done, if you want to see all my projects go to my <a href={myGithub} target='_blank' rel='noopener noreferrer' className='hover:text-black dark:hover:text-white hover:underline transition-all ease'>GitHub</a>.
      </p>
